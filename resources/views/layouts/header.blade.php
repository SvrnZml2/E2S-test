...
<header>
  <nav class="navbar navbar-expand-md navbar-dark essbg1">
    <a class="navbar-brand" href="{{ route('welcome') }}">
      <img src="{{asset('images/LaPlace-Transparent.png')}}" class="d-inline-block align-top" alt="logo La Place ess"></a>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown right-item-nav">
          <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">{{
            CompaniesController::WhoIsMyStruct() }}</a>
          ...
          <div class="dropdown-menu essbg2">
            ...
            @endif
            <a class="dropdown-item essbg3" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">{{
              __('se déconnecter') }}</a>
